...
void BatteryDisplay::paintEvent(QPaintEvent *)
{
	...
	pbattery2->setGeometry(BAT_PANEL_HEIGHT+25, 0, BAT_PANEL_WIDTH, BAT_PANEL_HEIGHT);
	pbattery2->show();
	...
	pbattery4->setGeometry(BAT_PANEL_HEIGHT+25, 450, BAT_PANEL_WIDTH, BAT_PANEL_HEIGHT);
	pbattery4->show();
